...
[CustomEditor(typeof(JumpReaction))]
public class JumpEditor : Editor
{
    private Transform jumpObjectTransform;
    ...
    {
        jumpObjectTransform = (target as JumpReaction).transform;
        so = serializedObject;
    ...
    {
        so.Update();
        Vector3 handlePos = propWaypointPosition.vector3Value + jumpObjectTransform.position;
        ...
        propWaypointPosition.vector3Value = handlePos - jumpObjectTransform.position;
